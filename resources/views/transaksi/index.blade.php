...
@section('judul')
<h6>Data Riwayat Transaksi</h6>
@endsection

@section('tombol_tambah')
  <a href="{{ route('transaksi.tambah') }}" type="submit" class="btn bg-gradient-info w-50">Tambah Data</a>
@endsection
...
<table class="table align-items-center mb-0">
    <thead>
      <tr>
        ...
        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">ID Pelanggan</th>
    ...
    <tbody>
          ...
          @foreach ($transaksi as $item)
            <tr>
              ...
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> id_pelanggan }}</td>
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> nama_pelanggan }}</td>
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> jenis_pembayaran }}</td>
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> created_at }}</td>
              <td>
                <a href="{{ route('transaksi.tampilkandata', $item->id) }}" type="a" class="btn btn-primary">Edit</a>
                <a href="{{ route('transaksi.deletedata', $item->id) }}" type="a" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          @endforeach
    </tbody>
