  ...
  <form action="{{ route('buku.tambah.simpan') }}" method="post" enctype="multipart/form-data">
        ...
        <table  class="table">
            <tr class="text-center">
                <td>Jenis Buku</td>
                <td><input class="form-control form-control-lg"  type="text" name="jenis_buku" required></td>
            </tr>
            <tr class="text-center">
                <td>Judul Buku</td>
                <td><input class="form-control form-control-lg"  type="text" name="judul_buku" required></td>
            </tr>
            <tr class="text-center">
                <td>Pengarang</td>
                <td><input class="form-control form-control-lg"  type="text" name="pengarang" required></td>
            </tr>
            <tr class="text-center">
                <td>Penerbit</td>
                <td><input class="form-control form-control-lg"  type="text" name="penerbit" quired></td>
            </tr>
            <tr class="text-center">
                <td>Tahun Terbit</td>
                <td><input class="form-control form-control-lg"  type="text" name="tahun_terbit" required></td>
            </tr>
            <tr class="text-center">
                <td>Harga</td>
            ...
            <tr class="text-center">
                <td>Jumlah Stock</td>
                <td><input class="form-control form-control-lg"  type="text" name="jumlah_stock" required></td>
            </tr>
            <tr class="text-center">
                <td colspan=3>
