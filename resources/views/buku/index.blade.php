...
@section('judul')
<h6>Data Stock Buku</h6>
@endsection

@section('tombol_tambah')
  <a href="{{ route('buku.tambah') }}" type="submit" class="btn bg-gradient-info w-50">Tambah Data</a>
@endsection
...
<table class="table align-items-center mb-0">
    <thead>
      <tr>
        ...
        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Jenis Buku</th>
    ...
    <tbody>
          ...
          @foreach ($buku as $item)
            <tr>
              ...
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> jenis_buku }}</td>
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> judul_buku }}</td>
              <td class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">{{ $item -> pengarang }}</td>
              ...
              <td>
                ...
                <a href="{{ route('buku.deletedata', $item->id) }}" type="a" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          @endforeach
    </tbody>
